function [T] = transmittanceTinyRaymodel(n0,nlayer,nsubstrate,height,width,wavelengths,angledeg,polarization,accuracy)
% transmittanceTinyRaymodel
% Simulate tiny transmittance of a monolayer using a ray based model    
%
% [T] = transmittanceTinyRaymodel(n0, nlayer,nsubstrate,height,width,wavelengths,angles,polarization,accuracy)
%    
%   Inputs
...
% Cosineof refraction angle angle
    ...
    delta = -pi+2*pi*stack(2)*height*costh_n(2)./wavelengths';
    for ix=1:numel(x)
