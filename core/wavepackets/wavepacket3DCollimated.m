...
function wavepacket =  wavepacket3DCollimated(incidence_angle_deg,azimuth_angle_deg,incident_refractiveindex,filterwidth)
...
%    
    ...
    function wavepacket_in = field(nu_x,nu_y,wavelength)    
        ...
        wavepacket_in_x=filterwidth*sinca(pi*filterwidth*(nu_x-incident_refractiveindex*sind(angle_x)./wavelength));
        wavepacket_in_y=filterwidth*sinca(pi*filterwidth*(nu_y-incident_refractiveindex*sind(angle_y)./wavelength));
