...
for a=1:numel(angledeg)
    ...
    for c=1:nbFilters
        ...
        Tray(:,c,a)=transmittanceTinyRayEquivalent(nair,neff,nsub,1-pi*nFWHM,width,cwl(c),wavelengths,angledeg(a),polarization,'accuracy',accuracy,'fastapproximation',true);
