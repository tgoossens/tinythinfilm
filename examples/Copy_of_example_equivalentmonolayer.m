...
for a=1:numel(angles)
    ...
    pixel=pixel2D('range',10+[0 5.5]);
   figure(a+10);
    displaySetup2D(filter,'pixel',pixel,'wavepacket',wavepacket)
    Tmono(:,a)=transmittanceTiny2D(filter_equivalent,wavepacket,wavelengths,polarisation,accuracy,pixel);
