...
for w=1:numel(widths)
    ...
    Ttiny(:,a,w)=transmittanceTiny2DCollimated(filter,angles(a),wavelengths,polarization,accuracy);
...
for w=1:numel(widths)
    ...
    for a=1:numel(angles)
        ...
        htiny(a)=plot(wavelengths,Ttiny(:,a,w),'color',[1 0.2 0.2],'linewidth',2)
